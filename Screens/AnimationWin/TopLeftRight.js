...
export default function TopLeftRight({ navigation }) {
   const [topRightLeftStart, setAnimationHeightEnd] = useState(
    new Animated.Value(0)
  );
  
  const animatedTopRigtLeft = {
    top:topRightLeftStart,
    left:topRightLeftStart,
    right:topRightLeftStart
  };

  const startAnimationWidthHeight = () => {
    Animated.timing(topRightLeftStart, {
      toValue: 30,
      duration: 100,
    }).start(() => {
      Animated.timing(topRightLeftStart, {
