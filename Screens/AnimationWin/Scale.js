    ...
    >
      <SafeAreaView>
        <TouchableWithoutFeedback onPress={startAnimationY}>
          <Animated.View style={[styles.boxY, animatedStylesY]} />
        </TouchableWithoutFeedback>
        <TouchableWithoutFeedback onPress={startAnimation}>
          <Animated.View style={[styles.box, animatedStyles]} />
        </TouchableWithoutFeedback>
        <TouchableWithoutFeedback onPress={startAnimationX}>
          <Animated.View style={[styles.boxX, animatedStylesX]} />
        </TouchableWithoutFeedback>
        <TouchableWithoutFeedback onPress={startAnimationRotate}>
          <Animated.View style={[styles.boxRotate, animatedStylesRotate]}>
              <Text>
                  Some Text
              </Text>
          </Animated.View>
